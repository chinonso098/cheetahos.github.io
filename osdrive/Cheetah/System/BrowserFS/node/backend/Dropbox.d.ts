...
export default class DropboxFileSystem extends BaseFileSystem implements FileSystem {
     ...
     */
    constructor(client: any, deprecateMsg?: boolean);
    getName(): string;
    isReadOnly(): boolean;
    ...
    _writeFileStrict(p: string, data: ArrayBuffer, cb: BFSCallback<any>): void;
    /**
     * Private
     * Returns a BrowserFS object representing the type of a Dropbox.js stat object
     */
    _statType(stat: any): FileType;
    /**
     * Private
     * Returns a BrowserFS object representing a File, created from the data
     * returned by calls to the Dropbox API.
     */
    _makeFile(path: string, flag: FileFlag, stat: any, buffer: Buffer): DropboxFile;
    /**
     * Private
     ...
     */
    convert(err: any, path?: string | null): ApiError;
}
