...
export declare class EmscriptenFile extends BaseFile implements File {
    ...
    write(buffer: any, offset: number, length: number, position: number, cb: BFSThreeArgCallback<number, Buffer>): void;
    writeSync(buffer: any, offset: number, length: number, position: number | null): number;
    read(buffer: any, offset: number, length: number, position: number, cb: BFSThreeArgCallback<number, Buffer>): void;
    readSync(buffer: any, offset: number, length: number, position: number | null): number;
